...
class Node:
    ...
    def __init__(self, context: RootBuildContext | TopLevelBuildContext, path: str) -> None: ...
...
class ProjectNode(Node):
    def __init__(self, context: RootBuildContext | TopLevelBuildContext, path: str, project: ProjectNode) -> None: ...
    @property
